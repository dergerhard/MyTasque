...
namespace MyTasque.Backends
{
	...
	/// </summary>
	public class DummyTaskList : MyTasqueObject, ITaskList
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MyTasque.Backends.DummyTaskList"/> class.
		/// </summary>
		/// <param name="name">Name.</param>
		public DummyTaskList(string name)
		{
			this.Name = name;
		...
		{
			ITask t = new DummyTask (name, dueDate, completed);
			this.Add (t);
			return t;
		}
