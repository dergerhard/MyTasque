...
{
	public class DummyTask : MyTasqueObject, ITask
	{
		/// <summary>
		/// Gets the notes.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="MyTasque.Backends.DummyTask"/> is completed.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MyTasque.Backends.DummyTask"/> class.
		/// </summary>
		/// <param name="name">Name.</param>
		/// <param name="dueDate">Due date.</param>
		/// <param name="completed">If set to <c>true</c> completed.</param>
		public DummyTask(string name, DateTime dueDate, bool completed=false)
		{
			this.Name = name;
